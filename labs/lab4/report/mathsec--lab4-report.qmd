...
Написан программный код на языке Julia [@doc-julia], реализующий алгоритм Евклида:
...
Написан программный код на языке Julia [@doc-julia], реализующий бинарный алгоритм Евклида:
...
Написан программный код на языке Julia [@doc-julia], реализующий расширенный алгоритм Евклида:
...
Написан программный код на языке Julia [@doc-julia], реализующий расширенный бинарный алгоритм Евклида:
